...
use crate::model_provider_info::FATHERPAUL_PROVIDER_ID;
...
impl Config {
    ...
    pub(crate) fn load_config_with_layer_stack(
        ...
        let model_provider_id = model_provider
            ...
            .unwrap_or_else(|| FATHERPAUL_PROVIDER_ID.to_string());
        ...
        let model = model
            ...
            .or(cfg.model)
            .or_else(|| Some("paul-code".to_string()));
        ...
        let config = Self {
            ...
            chatgpt_base_url: config_profile
                ...
                .unwrap_or("https://portal.fatherpaulai.com/".to_string()),
            realtime_audio: cfg
                .audio
