//! Registry of model providers supported by FatherPaul Code.
//!
//! Providers can be defined in two places:
//!   1. Built-in defaults compiled into the binary so FatherPaul Code works out-of-the-box.
...
const OPENAI_PROVIDER_NAME: &str = "Father Paul AI";
pub const OPENAI_PROVIDER_ID: &str = "openai";
pub const FATHERPAUL_PROVIDER_ID: &str = "fatherpaul";
...
pub enum WireApi {
    /// The Responses API exposed by Father Paul compatible providers at `/v1/responses`.
    #[default]
    Responses,
}
...
pub struct ModelProviderInfo {
    ...
    /// Does this provider require a managed login token? If true,
...
impl ModelProviderInfo {
    ...
    pub(crate) fn to_api_provider(
        ...
        let default_base_url = if matches!(auth_mode, Some(AuthMode::Chatgpt)) {
            "https://portal.fatherpaulai.com"
        } else {
            "https://api.fatherpaulai.com/v1"
        };
        let base_url = self
            .base_url
            .clone()
    ...
    pub fn create_openai_provider(base_url: Option<String>) -> ModelProviderInfo {
        ModelProviderInfo {
            ...
            base_url,
            env_key: Some("FATHERPAUL_API_KEY".into()),
            env_key_instructions: Some(
                "Set FATHERPAUL_API_KEY from your Father Paul AI account before running the CLI."
                    .into(),
            ),
            ...
            env_http_headers: Some(
                [
                    ("X-FatherPaul-Client".to_string(), "FATHERPAUL_CLIENT".to_string()),
                ]
                .into_iter()
                .collect(),
            ),
...
pub fn built_in_model_providers(
    ...
    // We only bundle the Father Paul provider and open source ("oss")
    // providers by default. Users are encouraged to add to
    // `model_providers` in config.toml to add their own providers.
    [
        (FATHERPAUL_PROVIDER_ID, openai_provider.clone()),
        (
